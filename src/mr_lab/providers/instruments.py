"""Explicit, verified provider decoding specifications for the FX universe."""
...
class ProviderInstrumentSpec:
    ...
    def __post_init__(self) -> None:
        ...
        if not self.decoding_verified:
            raise InstrumentSpecError("unverified price decoding is not permitted")
...
_SPECS = {
    # Verified against bounded 2024-01-02 public BID_candles_min_1.bi5 samples.
...
def get_instrument_spec(instrument: str) -> ProviderInstrumentSpec:
    """Resolve a canonical symbol without guessing aliases or price scales."""
