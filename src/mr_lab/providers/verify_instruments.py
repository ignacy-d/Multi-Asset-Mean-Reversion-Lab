...
from mr_lab.providers.dukascopy import acquire
from mr_lab.providers.dukascopy_bi5 import canonicalization_audit
...
def verify(output_dir: Path) -> Path:
    ...
    for instrument in VERIFICATION_INSTRUMENTS:
        raw_path, _ = acquire(output_dir, VERIFICATION_DAY, instrument=instrument)
        audit = canonicalization_audit(
